...
def trajectory_all_distance(tr_id, trs_compare_dict):
    ...
    # if not os.path.exists("./distance_compution/hausdorff_distance"):
    #     os.makedirs("./distance_compution/hausdorff_distance")
    # trs_matrix = distance.cdist(trs_compare_dict, {tr_id:trs_compare_dict[tr_id]},type="hausdorff")
    # pickle.dump(trs_matrix, open('./distance_compution/hausdorff_distance/hausdorff_distance_' + str(tr_id), 'wb'))

    # if not os.path.exists("./distance_compution/LCSS_distance"):
    #     os.makedirs("./distance_compution/LCSS_distance")
    # trs_matrix = distance.cdist(trs_compare_dict, {tr_id:trs_compare_dict[tr_id]},type="lcss",eps=200)
    # pickle.dump(trs_matrix, open('./distance_compution/LCSS_distance/LCSS_distance_' + str(tr_id), 'wb'))
    
    # if not os.path.exists("./distance_compution/EDR_distance"):
    #     os.makedirs("./distance_compution/EDR_distance")
    # trs_matrix = distance.cdist(trs_compare_dict, {tr_id:trs_compare_dict[tr_id]},type="edr",eps=200)
    # pickle.dump(trs_matrix, open('./distance_compution/EDR_distance/EDR_distance_' + str(tr_id), 'wb'))
    
    # if not os.path.exists("./distance_compution/DTW_distance"):
    #     os.makedirs("./distance_compution/DTW_distance")
    # trs_matrix = distance.cdist(trs_compare_dict, {tr_id:trs_compare_dict[tr_id]},type="dtw")
    # pickle.dump(trs_matrix, open('./distance_compution/DTW_distance/DTW_distance_'+str(tr_id), 'wb'))
...
def compute_distance():
    trjs = get_total_traj_dict("/home/changzhihao/data_mining_project/data/cluster_trajectory_point/")
    trs_compare_dict = {}
    for tr_id in trjs:
        tr = trjs[tr_id]
        trarray = []
