...
# Yolo-v5 release 
_C.MODEL.YOLO_WEIGHT = "yolov5x.pt"
# ReID weight 
_C.MODEL.EMB_WEIGHT = ".."
# If Yolo Using DNN
...
_C.MODEL.DETECT_CONF_THRE = 0.3
# Detection Iou Confidence Threshold
_C.MODEL.DETECT_IOU_THRE = 0.45
# Detection Filter By Class
_C.MODEL.DETECT_CLASSES = [2,5,7] # 0 # 2, 5, 7 排除了公交车
