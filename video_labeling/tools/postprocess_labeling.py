...
if __name__ == "__main__":    
    ...
    parser.add_argument("--read_path", type=str, default="./videos_result/new_tmp/label_our_jackson.txt", help="video path")
    parser.add_argument("--write_path", type=str, default="./videos_result/new_tmp/label_our_jackson_post.txt", help="video path")
    parser.add_argument("--video_path", type=str, default="./videos/jackson_1216.mp4", help="save video path")
    parser.add_argument("--write_video_path", type=str, default="./videos_result/new_tmp/jackson_post.mp4", help="save video path")
